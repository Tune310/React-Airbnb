...
class LosAngeles extends React.Component {
    ...
    render() {
            ...
            <div className="today-in-los-angeles-container">
                ...
                <div className="show-all"><a href="#">Show all (72) <span className="right-arrow"><svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false"><path d="m4.29 1.71a1 1 0 1 1 1.42-1.41l8 8a1 1 0 0 1 0 1.41l-8 8a1 1 0 1 1 -1.42-1.41l7.29-7.29z" fill-rule="evenodd"></path></svg></span></a></div>
            </div>
        )
    }
}
